...
def rose_sockets(cx, cy, R, bw):
    ...
    GAP = 2 * math.pi / N
    R_out = R - bw / 2.0
    # p=12 is structural: one petal approaches each of the 12 sockets.  The archived p=36
    # experiment added two unstamped petals between sockets; those full-flow strands crossed
    # inside the 1/8-inch stick envelope (measured in the 2026-07-29 artifact at r=1.346mm).
